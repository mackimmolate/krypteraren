...
`0.1.0` is the first authoritative documented release of the project.
...
- `0.1.0` on `2026-03-06`: first formally documented release, based on commits `8976eeb5` and `c5f001ac`
